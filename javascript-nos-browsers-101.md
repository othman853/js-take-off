...
Se você tem interesse sobre como o JavaScript funciona nos browsers \(e como ele é utilizado no desenvolvimento de aplicações front-end\), este capítulo abordará este tema, com pontos importantes que ajudam a entender o papel do JavaScript neste contexto.

Tópicos deste capítulo:

* [As tecnologias de uma página web](#web-technologies)
